    ...
    <>
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start space-y-3 sm:space-y-0">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-primary-forest">Inventory Management</h1>
            <p className="text-sm sm:text-base text-secondary-gray">Manage your inventory items, stock levels, and categories</p>
          </div>
          <button
            onClick={() => {
              setEditingItem(null)
        ...
        {loading ? (
          ...
          <div className="bg-accent-white rounded-xl shadow-sm border border-secondary-sage/10 p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-accent-white rounded-xl shadow-sm p-4 sm:p-6 border border-secondary-sage/10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-primary-forest">{inventoryData.pagination.total}</p>
                </div>
                <div className="p-2 sm:p-3 bg-primary-golden/10 rounded-lg flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary-golden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-accent-white rounded-xl shadow-sm p-4 sm:p-6 border border-secondary-sage/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-secondary-gray">Categories</p>
                  <p className="text-xl sm:text-2xl font-bold text-primary-forest">{categories.length}</p>
                </div>
                <div className="p-2 sm:p-3 bg-secondary-sage/10 rounded-lg flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-secondary-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {loading ? (
          ...
          <div className="text-center py-8 sm:py-12">
            <svg className="w-12 h-12 sm:w-16 sm:h-16 text-secondary-gray/50 mx-auto mb-3 sm:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
            <h3 className="text-base sm:text-lg font-medium text-secondary-gray mb-2">No items found</h3>
          ...
          <div className="flex justify-center mt-6 sm:mt-8">
            <div className="flex items-center space-x-1 sm:space-x-2">
              <button
                ...
                className="px-3 sm:px-4 py-2 text-xs sm:text-sm text-secondary-gray border border-secondary-gray rounded-lg hover:bg-primary-cream transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </button>
